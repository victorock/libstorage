...
//Targets list luns from all hosts, sessions and targets
// ls -1d /sys/class/fc_transport/rport-*\:*-*/device/target*\:*\:*
func Targets() []string {
	targets, _ := filepath.Glob(FCSESSIONDIR + "/rport-*:*-*/device/target*:*:*")
	return targets
}
